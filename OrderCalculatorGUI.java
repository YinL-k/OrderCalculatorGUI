...
*/
//OrderCalculatorGUI (aggregate class) has a
//BagelPanel ToppingPanel CoffeePanel GreetingPanel JPanel JButton 
...
public class OrderCalculatorGUI extends JFrame
{
   ...
   */
   ...
   /**
      ...
      Perform these actions when the calculate button is pressed.
   */
   ...
   private class CalcButtonListener implements ActionListener
   {
      ...
      {
         // Variables to hold the sub total, tax, and total
         ...
         String toppingMsg = toppings.getToppingMsg();
   ...
   /**
      ...
      Perform these actions when the Exit button is pressed.
   */
